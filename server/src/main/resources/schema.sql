...
CREATE TABLE IF NOT EXISTS migration_task (
    ...
    task_type VARCHAR(32) NOT NULL DEFAULT 'once' COMMENT '任务类型',
    ...
    status VARCHAR(32) DEFAULT 'draft' COMMENT '任务状态',
    ...
    next_exec_time VARCHAR(32) DEFAULT NULL COMMENT '下次执行时间',
...
CREATE TABLE IF NOT EXISTS verify_result (
    ...
    verify_status VARCHAR(32) DEFAULT 'pending' COMMENT '校验状态',
...
CREATE TABLE IF NOT EXISTS task_operation_log (
    ...
    operation VARCHAR(32) NOT NULL COMMENT '操作类型: create/edit/start/stop/kill/delete',
